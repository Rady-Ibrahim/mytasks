            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4 p-md-5">
                    <div class="text-center mb-4">
                        ...
                        <h1 class="h4 mt-3 mb-1">{{ __('Welcome back') }}</h1>
                        <p class="text-secondary small mb-0">{{ __('Sign in to manage your tasks') }}</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('login') }}" novalidate>
                        ...
                        <div class="mb-3">
                            ...
                            <input id="password" type="password" name="password" class="form-control @error('password') is-invalid @enderror mt-2" required autocomplete="current-password">
